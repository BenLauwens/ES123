...
begin
	...
	using Plots: plot, plot!, xlabel!, ylabel!, xlims!, title!
end
...
# ╔═╡ 0c80b40a-6f3f-4c3e-88d3-1dd80a96ac1d
for i in 1:3
	x = rand()
	println(x)
end

# ╔═╡ 414b1140-4cb7-41d9-a031-afa0f86f2905
md"""The function `rand` can take an iterator or array as an argument and return a random element:
"""

# ╔═╡ 3c11a8d1-e7e7-4b01-8ab9-796739a1eb6c
for i in 1:10
	x = rand(1:6)
	print(x, " ")
end

# ╔═╡ e0ee62cd-76fb-4fdb-ab1c-db310fb4fd9e
md"""### Exercise 13-5

Write a function named choosefromhist that takes a histogram as defined in “Dictionaries as Collections of Counters” and returns a random value from the histogram, chosen with probability in proportion to frequency. For example, for this histogram:
"""

# ╔═╡ 66d24466-7507-470a-9fe6-006dea91072e
histogram("aab")

# ╔═╡ 622b028f-720e-4701-97e6-1ec022105447
md"""your function should return `'a'` with probability `67` and `'b'` with probability `33`.
"""
...
# ╔═╡ b334d29f-6034-4c71-b0be-4b96b789aa50
hist = begin
	dir = joinpath(splitdir(@__FILE__)[1], "..", "data")
	processfile(joinpath(dir, "emma.txt"))
end

# ╔═╡ 0977a571-ae1f-4443-946c-898b2bdc141f
md"""This program reads *emma.txt*, which contains the text of *Emma* by Jane Austen.
...
# ╔═╡ 65593b6c-568e-4289-8d14-5b49e022af74
totalwords(hist) = sum(values(hist))

# ╔═╡ 312a5944-3720-41c7-8f1a-9a4649a48d19
md"""The number of different words is just the number of items in the dictionary:
"""

# ╔═╡ 59d9e032-2045-4588-9572-e618c940fb5f
differentwords(hist) = length(hist)

# ╔═╡ 2c470035-a41e-4c3a-800a-f83a288998af
md"""Here is some code to print the results:
"""

# ╔═╡ d026f2a6-6246-4e84-864c-1b56622ebae7
begin
...
# ╔═╡ a2dd5637-33eb-4a38-b2ed-a9986a920870
...
md"""In each tuple, the frequency appears first, so the resulting array is sorted by frequency. Here is a loop that prints the 10 most common words:
"""

# ╔═╡ 8f4dcd1d-8c51-43ed-a580-ed17cdc2bd5d
let
	t = mostcommon(hist)
	println("The most common words are:")
	for (freq, word) in t[1:5]
		println(word, "\t", freq)
	end
end

# ╔═╡ ef4e01de-6cba-4560-9227-c78f2d9d8b2d
md"""!!! tip
...
# ╔═╡ 60ef363b-21c3-4b9b-88e2-0eb51db94f56
function printmostcommon(hist, num=5)
	t = mostcommon(hist)
	println("The most common words are: ")
...
# ╔═╡ b597e6d0-dd8b-4e49-a5f0-9b08aa888562
md"""The first parameter is required; the second is optional. The *default value* of `num` is `5`. If you only provide one argument:
"""

# ╔═╡ 899df754-6c69-491d-a019-799e3bf783b9
printmostcommon(hist)

# ╔═╡ 06a2c845-016a-4d1a-af47-23a231dbe2ac
md"""`num` gets the default value. If you provide two arguments:
"""

# ╔═╡ 2ad025a4-094e-4626-9ce3-fe90c33bede8
printmostcommon(hist, 3)

# ╔═╡ 3e19ce90-aaa4-4bd1-aad1-0130e1a85aea
md"""`num` gets the value of the argument instead. In other words, the optional argument
...
# ╔═╡ d7b1f839-fb91-4fd0-9eae-3f798c82cb3e
...
# ╔═╡ 64767bea-fc46-4148-ba31-aa09bc14c3b8
md"""To find the words in the book you downloaded that are not in *words.txt*, you can use `processfile` to build a histogram for *words.txt*, and then `subtract`:
"""

# ╔═╡ 08477ceb-8ee4-4270-bb33-cd73d6dd9389
let
	words = processfile(joinpath(dir, "words.txt"))
	diff = subtract(hist, words)
	println("Words in the book that aren't in the word list:")
	for (nr, word) in enumerate(keys(diff))
		print(word, " ")
		if nr > 20 break end
	end
end

# ╔═╡ f008d6ef-7a99-46f5-952b-73f64c8b1541
md"""Some of these words are names and possessives. Others, like “rencontre,” are no longer in common use. But a few are common words that should really be in the list!
...
# ╔═╡ ebfaaa26-282a-4f7a-8856-ad2b03ed4683
...
# ╔═╡ 46c81e56-7cbb-4480-bf39-b74ac9d0849e
md"""This algorithm works, but it is not very efficient; each time you choose a random word it rebuilds the array, which is as big as the original book. An obvious improvement is to build the array once and then make multiple selections, but the array is still big.
...
# ╔═╡ 5a1c78e0-3487-4b32-85be-28cea0c7eaf8
let
...
# ╔═╡ 5ab623d2-6d46-4913-85bd-ba6399fefe6a
md"""Use the Plots library to plot the results and check whether they form a straight line.
"""
